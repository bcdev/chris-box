 ...
 */
public class NoiseReductionPanelDraft extends JPanel {

    public static void main(String[] args) {
        JFrame frame = new JFrame("Noise Reduction");
        frame.setContentPane(new NoiseReductionPanelDraft());
     ...
     */
    public NoiseReductionPanelDraft() {
        initComponents();
    }
    ...
    private void removeButtonActionPerformed(
            ActionEvent evt) {//GEN-FIRST:event_removeButtonActionPerformed
