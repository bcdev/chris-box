...
@OperatorMetadata(alias = "chris.MakeClusterMap2",
                  ...
                  internal = true)
public class MakeClusterMapOp2 extends Operator {
    ...
    public void initialize() throws OperatorException {
        try {
            ...
            final Band targetBand = new ImageBand("class_indices", ProductData.TYPE_INT16, w, h);
            ...
            targetBand.setImage(ClusterMapOpImage2.createImage(sourceBands, calculator, indexFilter, clusters.length));
        } catch (Throwable e) {
