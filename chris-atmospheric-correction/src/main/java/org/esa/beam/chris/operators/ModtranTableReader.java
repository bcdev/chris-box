...
/**
 * Reader for MODTRAN tables.
 *
 * @author Ralf Quast
 * @version $Revision$ $Date$
 * @since BEAM 4.2
 */
class ModtranTableReader {

    // unit conversion constant
    private static final double DEKA_KILO = 1.0E4;

    @SuppressWarnings({"ConstantConditions"})
    public RtcTableFactory createRtcTableFactory() throws IOException {
        ...
        try {
            ...
            return new RtcTableFactory(new Array.Float(wavelengths), lutA, lutB);
        } catch (Exception e) {
