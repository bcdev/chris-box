...
/**
 * Creates tables with radiative transfer calculations.
 *
 * @author Ralf Quast
 * @version $Revision$ $Date$
 */
class RtcTableFactory {
    ...
    public RtcTableFactory(Array wavelengths, VectorLookupTable lutA, VectorLookupTable lutB) {
    ...
    /**
     * Creates the table of radiative transfer calculations suitable for the input parameters
