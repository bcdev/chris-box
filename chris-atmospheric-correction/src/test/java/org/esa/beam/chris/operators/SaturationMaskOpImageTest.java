...
/**
 * Tests for class {@link SaturationMaskOpImage}.
 *
 * @author Ralf Quast
 * @version $Revision$ $Date$
 * @since BEAM 4.2
 */
public class SaturationMaskOpImageTest extends TestCase {
    ...
    public void testImageComputation() {
        ...
        assertEquals(1, raster.getSample(2, 0, 0));
    ...
    private static RenderedImage createTestImage() {
        ...
        addBand(product, "mask_0", new short[]{0, 0, 0, 2, 0, 0});
        addBand(product, "mask_1", new short[]{0, 1, 0, 2, 0, 0});
        addBand(product, "mask_2", new short[]{0, 0, 2, 0, 0, 0});
        addBand(product, "mask_3", new short[]{0, 0, 0, 1, 0, 0});

        return SaturationMaskOpImage.createImage(product.getBands());
    }
