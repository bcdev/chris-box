...
/**
 * Tests for class {@link SpectrumMaskOpImage}.
 *
 * @author Ralf Quast
 * @version $Revision$ $Date$
 * @since BEAM 4.2
 */
public class SpectrumMaskOpImageTest extends TestCase {
    ...
    public void testImageComputation() {
        ...
        assertEquals(3, raster.getSample(0, 1, 0));
    ...
    private static RenderedImage createTestImage() {
        ...
        return SpectrumMaskOpImage.createImage(product.getBands());
    }
