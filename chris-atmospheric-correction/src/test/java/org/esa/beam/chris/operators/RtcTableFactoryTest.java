...
/**
 * Tests for class {@link RtcTableFactory}.
 *
 * @author Ralf Quast
 * @version $Revision$ $Date$
 */
public class RtcTableFactoryTest extends TestCase {

    // unit conversion constant
    private static final double DEKA_KILO = 1.0E4;

    private RtcTableFactory factory;

    @Override
    protected void setUp() throws Exception {
        // too expensive for unit-testing
        factory = new ModtranTableReader().createRtcTableFactory();
    }
