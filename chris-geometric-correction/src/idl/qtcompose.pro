...
;
;  $Id: qtcompose.pro,v 1.1 2003/01/24 19:49:17 m214044 Exp $
;
;-
...
function qtcompose, axis, phi
  ...
  nq  = nv > nph	; Selects the greater value
  q = make_array(value=axis[0]*phi[0]*0., 4,nq)		; Creates an array of dimensions 4 x nq, and filled with the given value
